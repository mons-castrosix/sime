    ...
    const submitReview = () => {
            ...
            Axios.post("http://54.219.124.66:3001/api/insert",
                //"http://localhost:3001/api/insert-estructura",
                {
                    ...
                    otra_red: otra, lat: document.getElementById("lat").value, lng: document.getElementById("lng").value, id_Secc: idSecc, observaciones: observaciones, idEquipo:equipo,injerencia:seccionInjerencia
                }).then(() => {
                    console.log("succes")
                    //alert("AGREGADO")
                    navigate('/estructura')
                            ...
                            <div className="row gx-3 mb-3">
                                ...
                                <div className="col-md-7">
                                    ...
                                    >
                                        ...
                                        <option value="7">Territoral</option>
