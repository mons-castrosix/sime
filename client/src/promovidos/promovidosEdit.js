...
function PromovidosEdit() {
    ...
    const getList = async (e) => {
        ...
        try {
            const res = await Axios.post(//"http://localhost:3001/apoyoId",{id:id}
                "http://localhost:3001/promovidos/detalles/" + id
            );
    ...
    const submitReview = () => {
        ...
        Axios.post(//"http://54.219.124.66:3001/insert-promovido",
            "http://localhost:3001/promovidos/edit/"+id,
            //"http://ec2-54-219-124-66.us-west-1.compute.amazonaws.com:3001/insert-promovido",
            {
                ...
                otra_red: otra,  lat: document.getElementById("lat").value, lng: document.getElementById("lng").value, id_promotor: promotor, observaciones: observaciones, id_Secc: idSecc
            }).then((response) => {
