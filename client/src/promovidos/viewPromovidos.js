...
function ViewPromovidos() {
    ...
    const getList = () => {
        Axios.post(//"http://localhost:3001/apoyoId",{id:id}
            "http://localhost:3001/promovidos-view/" + id,
        ).then((response) => {
            ...
            document.getElementById("promovidopor").selectedIndex = list[0].promotor //select
