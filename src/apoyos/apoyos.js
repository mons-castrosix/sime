...
function Apoyos() {
  ...
  <div className="card">
    ...
    <div className="card-body">
      ...
      <form id="apoyoForm" action="#" method="POST" className="needs-validation" >
      ...
      <div className="form-row">
        <div className="row px-1">
          ...
          <input type="text" className="form-control" id="celectoral" name="celectoral" placeholder="Clave electoral"  required />
          </div>
          <div className="form-group col-lg-3 col-md-3 col-sm-3 col-6">
      ...
      <div className="form-row">
        <div className="row px-1">
          <div className="form-group col-lg-4 col-md-6">
            ...
            <input type="text" className="form-control" id="df" name="df" required />
            
          </div>
          <div className="form-group col-lg-4 col-md-6">
            <label htmlFor="df">Distrito Local</label>
            <input type="text" className="form-control" id="dl" name="dl" required />
            
          </div>
          <div className="form-group col-lg-4 col-md-6">
            <label htmlFor="nivel">Nivel</label>
            <select className="form-control mr-1"  id="nivel" name="nivel" required>
      ...
      <div className="form-row">
        <div className="row px-1">
          <div className="form-group col-lg-4 col-md-6">
            ...
            <input type="text" className="form-control" id="cel" name="cel" required />
          </div>
          <div className="form-group col-lg-4 col-md-6">
            <label htmlFor="email">Email</label>
            <input type="email" className="form-control" id="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required />
            
          </div>
          <div className="form-group col-lg-4 col-md-6">
            <label htmlFor="fb">Facebook</label>
            <input type="text" className="form-control" id="fb" name="fb" placeholder=""  required />
      ...
      <div className="form-row">
        <div className="row px-1">
          ...
          <label htmlFor="tw">Twitter</label>
            <input type="text" className="form-control" id="tw" name="tw" placeholder=""  required />
            
          </div>
          <div className="form-group col-lg-6 col-md-6">
            <label htmlFor="otrared">Otra red social</label>
            <input type="text" className="form-control" id="otrared" name="otrared" placeholder=""  required />
      ...
      <div className="form-row">
        <div className="row px-1">
          ...
          <label htmlFor="tw">Monto de Apoyo</label>
            <input type="number" className="form-control" id="tw" name="tw" placeholder=""  required />
      ...
      <div className="form-row">
        <div className="row">
          ...
          <div className="form-group col-lg-3 col-md-6"></div>
          <div className="form-group col-lg-3 col-md-6"></div>
          <div className="form-group col-lg-6 col-md-6">
          <button  className="btn btn-primary btn-block col-lg-2" type="submit">Guardar</button>
          </div>
